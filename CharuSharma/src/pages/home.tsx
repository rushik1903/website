    ...
    return (
        <div className="homeContainer" style={{minHeight:"100vh"}}>
            ...
            <div style={{flexGrow:'1'}}>
                ...
                <a className="twitter-timeline" href="https://twitter.com/sh_charu?ref_src=twsrc%5Etfw">Tweets by sh_charu</a> <script async src="https://platform.twitter.com/widgets.js" charet="utf-8"></script>
